...
public final class Message {
    ...
    public static final String GROUP_ALERT_TIMETABLE = "New Schedule for Group updated";
    public static final String TEACHER_ALERT_TIMETABLE = "New Schedule for Teacher updated";
